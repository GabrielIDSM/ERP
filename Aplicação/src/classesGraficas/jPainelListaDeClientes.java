...
import classesUtilit.ListaDeClientesTableModel;
import java.util.List;
import model.bean.Cliente;
import model.dao.ClienteDAO;

public class jPainelListaDeClientes extends javax.swing.JPanel {
    //Atributos
    int tipoDeConta;
    String strlogin;
    //Getters e Setters
    ...
    //Construtor
    public jPainelListaDeClientes(String strlogin, int tipoDeConta) {
        setStrlogin(strlogin);
        setTipoDeConta(tipoDeConta);
        initComponents();
        ListaDeClientesTableModel tableModel = new ListaDeClientesTableModel();
